...
const NotificationPage = () => {
  ...
  const [settings, setSettings] = useState({
    ...
    defaultCreditPeriod: 'net30',
    allowPrePaid:        false,
    autoBlockOnBreach:   true,
    gracePeriod:         '3',
    // Tab 2
    minOrderValue:          '10000',
              ...
              <div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      value={settings.dealerIdFormat}
                      onChange={(e) => set('dealerIdFormat', e.target.value)}
                    ...
                    >
                      <option value="auto">Auto | Enter code Prefix</option>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      value={settings.defaultDealerType}
                      onChange={(e) => set('defaultDealerType', e.target.value)}
                      className="text-sm border border-slate-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 w-36"
                    >
                  ...
                  <div className="border-t border-slate-100 pt-4 space-y-3">
                    ...
                    <div className="bg-slate-50 rounded-lg p-3">
                      <p className="text-xs font-medium text-slate-600 mb-0.5">
                        Require minimum 3 or 4 Docs for Approval
                      </p>
                      <p className="text-xs text-slate-400">
                        Dealers must satisfy minimum required requirements.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-lg">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select
                    value={settings.defaultCreditPeriod}
                    onChange={(e) => set('defaultCreditPeriod', e.target.value)}
                    className="text-sm border border-slate-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 w-36"
                  >
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select
                    ...
                    onChange={(e) => set('allowBackorders', e.target.value)}
                    className="text-sm border border-slate-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 w-36"
                  >
                    {['3', '6', '7', '14', '30'].map((d) => (
                      <option key={d} value={d}>{d} days</option>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select
                    value={settings.maxBackorderDays}
                    onChange={(e) => set('maxBackorderDays', e.target.value)}
                    className="text-sm border border-slate-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 w-36"
                  >
                    {['1', '2', '3', '5', '7', '14'].map((d) => (
                      <option key={d} value={d}>{d} days</option>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select
                    ...
                    onChange={(e) => set('defaultPriceTier', e.target.value)}
                    className="text-sm border border-slate-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 w-36"
                  >
